...
export abstract class IQuery {
    ...
    abstract extractor(id: string): Nullable<Extractor> | Promise<Nullable<Extractor>>;

    abstract extractores(filtro?: Nullable<FiltroExtractorInput>): Extractor[] | Promise<Extractor[]>;
}
...
export abstract class IMutation {
    abstract crearExtractor(input: CrearExtractorInput): Extractor | Promise<Extractor>;

    abstract actualizarExtractor(id: string, input: ActualizarExtractorInput): Extractor | Promise<Extractor>;

    abstract eliminarExtractor(id: string): boolean | Promise<boolean>;

    abstract ejecutarExtraccion(id: string, input: ArchivoExtraccionInput): ResultadoExtraccion | Promise<ResultadoExtraccion>;
}
